...
class RandChinaName extends BaseController
{
    ...
    {
        $xing_list = $this->getXingList();
        return $xing_list[mt_rand(0, count($xing_list) - 1)];
    }
    ...
    {
        $ming_list = $this->getMingList();
        return $ming_list[mt_rand(0, count($ming_list) - 1)];
    }
    ...
    public function getName($count = 1)
    {
        ...
        switch ($count) {
            case 1:
                ...
                break;
            case 2:
                $name .= $this->getMing() . $this->getMing();
                break;
            default:
                $rand = mt_rand(1, 10);
                if ($rand % 2 == 1) {
